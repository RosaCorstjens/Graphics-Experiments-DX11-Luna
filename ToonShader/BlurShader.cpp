...
const D3D11_INPUT_ELEMENT_DESC BlurShader::_inputLayoutDesc[3] =
{
...
: _screenWidth(0), _padding(0), TextureShader() {}

BlurShader::BlurShader(const BlurShader&) {}

BlurShader::~BlurShader() {}

bool BlurShader::Initialize(ID3D11Device* device, HWND hwnd) {
	bool result = InitializeShader(device, hwnd, L"FX/BlurShader.fx");
...
bool BlurShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* filename) {
	...
	_technique = _FX->GetTechniqueByName("HorizontalBlur");  
