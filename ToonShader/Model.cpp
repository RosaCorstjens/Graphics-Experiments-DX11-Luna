...
bool Model::LoadTexture(ID3D11Device* deviceContext, WCHAR* diffFilename) {
...
bool Model::SetMaterial(XMFLOAT4 ambient, XMFLOAT4 diffuse, XMFLOAT4 specular, XMFLOAT4 reflect) {
