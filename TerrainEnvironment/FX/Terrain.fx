		  ...
		  uniform bool gFogEnabled) : SV_Target
{
    ...
    float4 c0 = gLayerMapArray.Sample(samLinear, float3(pin.Tex.xy * gTexScale, 0.0f));
    float4 c1 = gLayerMapArray.Sample(samLinear, float3(pin.Tex.xy * gTexScale, 1.0f));
    float4 c2 = gLayerMapArray.Sample(samLinear, float3(pin.Tex.xy * gTexScale, 2.0f));
    float4 c3 = gLayerMapArray.Sample(samLinear, float3(pin.Tex.xy * gTexScale, 3.0f));
    float4 c4 = gLayerMapArray.Sample(samLinear, float3(pin.Tex.xy * gTexScale, 4.0f));
