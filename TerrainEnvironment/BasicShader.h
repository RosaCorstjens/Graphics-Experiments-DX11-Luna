...
public:
	...
	ID3D11InputLayout* GetOrthoWindowInputLayout() { return _inputLayout; }
...
protected:
	...
	static const D3D11_INPUT_ELEMENT_DESC _orthoWindowInputLayoutDesc[2];
	ID3D11InputLayout* _orthoWindowInputLayout;
